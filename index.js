...
const ownerNumber = ['252682219373']

//===================SESSION-AUTH============================
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
if(!config.SESSION_ID) return console.log('Please add your session to SESSION_ID env !!')
const sessdata = config.SESSION_ID.replace("ABDIWAHID-MD~", '');
...
console.log("CONNECTING AQOON-MD 🧬...");
...
console.log('ABDIWAHID-MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ ABDIWAHID-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ AQOONYAHANKA ✅*
...
//================ownerreact==============
if(senderNumber.includes("252682219373")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("252682219373")){
...
app.get("/", (req, res) => {
res.send("HEY, ABDIWAHID-MD STARTED ✅");
});
